...
export default function updateHighlighting(selection: svgBaseType, visualObj: Visual) {
  ...
  const opacityFull: number = visualObj.viewModel.inputSettings.scatter.opacity.value;
  const opacityReduced: number = visualObj.viewModel.inputSettings.scatter.opacity_unselected.value;
